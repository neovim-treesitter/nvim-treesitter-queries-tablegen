# nvim-treesitter-queries-tablegen

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-tablegen/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-tablegen/actions/workflows/validate.yml)

Neovim tree-sitter queries for **tablegen**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-tablegen",
...
- [ ] Changes are scoped to `tablegen` — do not include files for other languages
